...
namespace Bin2019.Action
{
	class RegisterAction
	{
		...
		public static int RegisterEnroll(string rc001, string rc109, string fa001, string rc002, string rc202, string rc003, string rc303, int rc004, int rc404,
			string rc014, string rc050, string jkid,string rc051, string rc052, string rc055, string rc099, string rc130, decimal price, DateTime rc140, DateTime rc150,
			decimal nums, string source, string handler
			)
		{
			return RegisterEnroll(rc001, rc109, fa001, rc002, rc202, rc003, rc303, rc004, rc404, rc014, rc050,jkid, rc051, rc052, rc055, rc099, rc130, price, rc140, rc150, nums, source,
			...
			)
		{
			...
			//交款人身份证号
			OracleParameter op_jkid = new OracleParameter("ic_jkid", OracleDbType.Varchar2, 20);
			op_jkid.Direction = ParameterDirection.Input;
			op_jkid.Value = jkid;
			...
			if (itemId_arry == null)
				...
				{op_rc001 , op_rc109, op_fa001, op_rc002, op_rc202, op_rc003, op_rc303, op_rc004, op_rc404,
				 op_rc014, op_rc050, op_jkid,op_rc051,op_rc052, op_rc055,op_rc099, op_rc130, op_price,op_rc140,
		...
		/// <param name="handler"></param>
		/// <returns></returns>
		public static int RegisterPay(string rc001, string fa001, decimal price, decimal nums, string handler,string jkid)
		{
			//逝者编号
			OracleParameter op_rc001 = new OracleParameter("ic_rc001", OracleDbType.Varchar2, 10);
			op_rc001.Direction = ParameterDirection.Input;
			...
			return SqlAssist.ExecuteProcedure("pkg_business.prc_RegisterPay", new OracleParameter[]
				{op_rc001 ,op_fa001,op_price,op_nums,op_handler,op_jkid });
		}
