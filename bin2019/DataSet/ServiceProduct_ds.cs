...
namespace Bin2019.DataSet
{
    ...
    class ServiceProduct_ds : System.Data.DataSet
    {
        ...
        public ServiceProduct_ds()
        {
            ...
            DataColumn col_si099 = new DataColumn("SI099", typeof(string));   // 财务发票编码
            ...
            Si01.Columns.AddRange(new DataColumn[]
                {col_si001,col_si002,col_si003,col_price,col_si005,col_si088,col_sortId,col_si099,col_status});
            ...
            Gi01.Columns.AddRange(new DataColumn[]
                {col_gi001,col_gi002,col_gi003,col_price2,col_gi088,col_sortId2,col_gi099,col_status_2});
